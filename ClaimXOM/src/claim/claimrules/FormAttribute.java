...
public class FormAttribute {
    ...
    public String toString() {
        ...
        sb.append(FormAttribute.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FormAttribute) == false) {
            return false;
        }
        FormAttribute rhs = ((FormAttribute) other);
